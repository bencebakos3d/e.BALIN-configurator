...
export const { toggleOption, increaseCost, decreaseCost, toggleFullscreen, setKarpitColor, changeOptionCount } = horgaszSlice.actions;

export default horgaszSlice.reducer;
